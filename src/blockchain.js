        ...
        return new Promise(async (resolve, reject) => {
            ...
            if((time + (5*60*1000)) >= currentTime){ 
                ...
                if(isValid){
                    ...
                    reject("The signature is not valid !!");
                }
            } else {
                reject("Star should be submited before 5 minutes !!");
            }
        });
    }
            ...
            self.chain.forEach(block => {
                ...
                if(block.height > 0) {
                    ...
                    if(blockHash != previousBlockHash){
                        errorList.push(`[Error] Block Heigh: ${block.height} >> Previous Hash don't match.`);
                    }
                }
                i++;
            });
